...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push(
                ...
                '<li class="skip "><font class="skip-00 ">跳转</font><input class="skip-01 "><button class="skip-02 btn btn-primary btn-sm">go</button></li>',
                '</ul>',
                '</div>');
        }
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $skip=this.$pagination.find('.skip-02');
            ...
            // console.log($number)
            $number.on('click', $.proxy(this.onPageNumber, this));
            $skip.off('click').on('click', $.proxy(this.onPageSkip, this));
    ...
    BootstrapTable.prototype.onPageSkip = function (event) {

        this.options.pageNumber = $(".pagination").find(".skip-01").val();
        ...
        var _index=parseInt(this.options.pageNumber)
        //this.updatePagination(event);
        this.selectPage(_index)
