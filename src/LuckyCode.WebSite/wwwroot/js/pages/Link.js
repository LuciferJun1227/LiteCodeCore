var TableInit = function () {
    ...
    t.Init = function () {
        var tableindex = $('#Sys_DataGrid')
            .dataGrid({
                url: '/SysManager/Links/GetListViewModel', //请求后台的URL（*）
                ...
                columns: [
                    ...
                    , {
                        ...
                        formatter: function (value, row, index) {
                            return "<a href='Edit/" + row.LinkID + "' class='btn btn-flat btn-xs btn-info'><i class='glyphicon glyphicon-pencil'></i>编辑</a><a data-delete=1 data-id=" + row.LinkID + "  class='btn btn-flat btn-xs btn-warning'><i class='glyphicon glyphicon-remove'></i>删除</a>";
                        }
                    }
                ]
            });
...
$(document).ready(function () {
    ...
    $(document).on("click", "#Sys_DataGrid a[data-delete=1]", function () {
        ...
        layer.confirm('你确定要删除？', {
            ...
            $.get("/SysManager/Links/Delete/", { Id: id }, function () {
