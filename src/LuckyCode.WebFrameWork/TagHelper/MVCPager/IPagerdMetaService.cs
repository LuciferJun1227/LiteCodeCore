...
{
    public interface IPagerdMetaService
    {
        PagerMetaModel  GetMetaData(int collectionSize, int selectedPageNumber, int itemsPerPage);
    }

    public class PagerdMetaService : IPagerdMetaService
    {
        /// <summary>
        ...
        public PagerMetaModel GetMetaData(int collectionSize, int selectedPageNumber, int itemsPerPage)
        {
            _pages = BuildPageNodes(collectionSize, selectedPageNumber, itemsPerPage);
            return new PagerMetaModel
            {
        ...
        private List<Page> BuildPartialList(int collectionSize, int selectedPageNumber, int itemsPerPage)
        {
            ...
            if (selectedPageNumber == 0) selectedPageNumber = 1;
